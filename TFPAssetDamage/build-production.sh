...
# ===================================================================
# Script di Build e Push per Ambiente di Produzione - TFP Asset Damage Collector Service
# ===================================================================
# Questo script builda l'immagine Docker del servizio TFP Asset Damage Collector
...
show_help() {
    ...
    echo "  -n, --name IMAGE_NAME         Nome dell'immagine (default: notifier)"
...
VERSION="1.0.0"
IMAGE_NAME="tfp-asset-damage-collector"
SKIP_PUSH=false
SKIP_TESTS=false
...
echo ""
echo "╔════════════════════════════════════════════════════════╗"
echo "║   TFP Asset Damage Collector - Build Production Image  ║"
echo "╚════════════════════════════════════════════════════════╝"
echo ""
...
# Build Image
log_info "Building TFP Asset Damage Collector service image..."
...
log_success "TFP Asset Collector image buildata: ${FULL_IMAGE_NAME}"
...
if [ "$SKIP_PUSH" = false ]; then
    ...
    echo "  docker run -d --name notifier ${FULL_IMAGE_NAME}"
else
