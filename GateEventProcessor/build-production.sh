...
# ===================================================================
# Script di Build e Push per Ambiente di Produzione - Gate Event Processor Service
# ===================================================================
# Questo script builda l'immagine Docker del servizio Gate Event Processor
...
VERSION="1.0.0"
IMAGE_NAME="gate-event-processor"
SKIP_PUSH=false
SKIP_TESTS=false
...
echo ""
echo "╔════════════════════════════════════════════════════════╗"
echo "║  Gate Event Processor SERVICE - Build Production Image   ║"
echo "╚════════════════════════════════════════════════════════╝"
echo ""
...
# Build Image
log_info "Building Gate Event Processor service image..."
...
log_success "Gate Event Processor image buildata: ${FULL_IMAGE_NAME}"
