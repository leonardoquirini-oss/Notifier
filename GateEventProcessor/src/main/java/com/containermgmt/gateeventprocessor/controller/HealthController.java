package com.containermgmt.gateeventprocessor.controller;
 ...
 * - GET /api/health/ready : readiness con check Valkey. Richiede X-API-Key. 503 se DOWN.
...
public class HealthController {
    ...
    private static final String SERVICE_NAME = "gate-event-processor";
