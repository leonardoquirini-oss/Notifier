...
# ===================================================================
# Script di Build e Push per Ambiente di Produzione - LogProcessor Service
# ===================================================================
# Questo script builda l'immagine Docker del servizio LogProcessor
...
VERSION="1.0.0"
IMAGE_NAME="berlnk-logprocessor"
SKIP_PUSH=false
SKIP_TESTS=false
...
echo ""
echo "╔════════════════════════════════════════════════════════╗"
echo "║     LOG PROCESSOR SERVICE - Build Production Image     ║"
echo "╚════════════════════════════════════════════════════════╝"
echo ""
...
# Build Image
log_info "Building LogProcessor service image..."
...
log_success "LogProcessor image buildata: ${FULL_IMAGE_NAME}"
