...
# ===================================================================
# Script di Build e Push per Ambiente di Produzione - Notifier Service
# ===================================================================
# Questo script builda l'immagine Docker del servizio Notifier
...
echo ""
echo "╔════════════════════════════════════════════════════════╗"
echo "║     NOTIFIER SERVICE - Build Production Image          ║"
echo "╚════════════════════════════════════════════════════════╝"
echo ""
...
# Build Image
log_info "Building notifier service image..."
...
log_success "Notifier image buildata: ${FULL_IMAGE_NAME}"
