package com.containermgmt.eventcontrolprocessor.controller;
 ...
 * - GET /api/health/ready : readiness con check DB + Valkey. Richiede X-API-Key. 503 se DOWN.
...
public class HealthController {
    ...
    private static final String SERVICE_NAME = "event-control-processor";
